...
function colourCMYK(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupBlack, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupCyan, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupMagenta, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupYellow, { empty: false })) {
...
function colourHSL(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupHue, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupLightness, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupSaturation, { empty: false })) {
...
function colourHSLA(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupAlpha, { empty: false })) {
...
function colourHWB(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupBlackness, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupWhiteness, { empty: false })) {
...
function colourRGB(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupBlue, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupGreen, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupRed, { empty: false })) {
...
function email(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupDomain, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupLocal, { empty: false })) {
...
function regularExpression(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupFlag, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupSource, { empty: false })) {
...
function semanticVersioning(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupBuild, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupMajor, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupMinor, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupPatch, { empty: false })) {
	...
	if (!advancedDetermine.isString(option.groupPreRelease, { empty: false })) {
...
function shebang(option = {}) {
	...
	if (!advancedDetermine.isString(option.groupCommand, { empty: false })) {
