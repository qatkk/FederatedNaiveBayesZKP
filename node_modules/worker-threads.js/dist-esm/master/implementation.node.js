...
export let workerImplementationType = 'worker-thread';
function initTinyWorker() {
    ...
    class Worker extends TinyWorker {
        constructor(scriptPath, options) {
            ...
            workerImplementationType = (_a = options === null || options === void 0 ? void 0 : options._implementation) !== null && _a !== void 0 ? _a : 'worker-thread';
            if (!resolvedScriptPath) {
                // `options.fromSource` is true
                const sourceCode = scriptPath;
