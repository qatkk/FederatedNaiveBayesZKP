...
exports.isWorkerRuntime = exports.getWorkerImplementation = exports.workerImplementationType = exports.defaultPoolSize = void 0;
...
exports.workerImplementationType = 'worker-thread';
function initTinyWorker() {
    ...
    class Worker extends TinyWorker {
        constructor(scriptPath, options) {
            ...
            exports.workerImplementationType = (_a = options === null || options === void 0 ? void 0 : options._implementation) !== null && _a !== void 0 ? _a : 'worker-thread';
            if (!resolvedScriptPath) {
                // `options.fromSource` is true
                const sourceCode = scriptPath;
...
function selectWorkerImplementation() {
    return getTinyWorker();
}
function getTinyWorker() {
